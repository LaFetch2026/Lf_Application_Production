                          ...
                          Visibility(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                Padding(
                                  padding:
                                      EdgeInsets.only(top: 28.sp, left: 16.sp),
                                  child: AppText(
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        children: [
                                                                          GestureDetector(
                                                                            onTap:
                                                                                () async {
                                                                              Navigator.of(context).push(MaterialPageRoute(builder: (BuildContext context) => ProductDetailsScreen(productId: value.orderList[index]["product"]["id"], brandName: value.orderList[index]["product"]["brand_name"], backgroundcolor: widget.backgroundcolor, type: "add"))).then((value) => setState(
                                                                                    () {
                                                                                      productController.hasnextpage.value = true;
                                                                                      productController.loadMore.value = false;
                                                                                      productController.isProduct.value = false;
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        onPressedSecond:
                                                                          ...
                                                                          if (value.orderList[index]["product"]
                                                                              [
                                                                              "wishlisted"]) {
                                                                            wishlistController.callAddProductToWishlist(value.orderList[index]["product"]["wishlist_id"],
                                                                  ...
                                                                  children: [
                                                                    GestureDetector(
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        children: [
                                                                          Visibility(
                                                                            visible: controller.couponText.value == "Apply Coupon"
                                                                                ? true
                                                                                : false,
                                                                            child:
                                                                                ImageIcon(
                                                                          ...
                                                                          Visibility(
                                                                            ...
                                                                            child:
                                                                              ...
                                                                              child: AppText(
                                                                                text: "Saved ₹${controller.couponSave.value}",
                                                                                fontFamily: "Franklin Gothic",
                                                                                fontWeight: FontWeight.w500,
                                                                    ...
                                                                    GestureDetector(
                                                                      onTap:
                                                                        ...
                                                                        if (controller.cartDetails["discount"] !=
                                                                            null) {
                                                                          controller
                                                                              .callRemoveCoupon(widget.backgroundcolor);
                                                                        } else {
                                                                          controller
                                                                              .getCouponData(widget.backgroundcolor);
                                                                        }
                                                                      },
                                                                      child: controller
                                                                              .isRemoveCoupan
                                                                          ...
                                                                          : controller.cartDetails["discount"] != null
                                                                              ? AppText(
                                                                      ...
                                                                      GestureDetector(
                                                                        onTap:
                                                                          ...
                                                                          Get.to(
                                                                            ...
                                                                            onPressed:
                                                                                (p0) {
                                                                              controller.couponText.value = p0;
                                                                              controller.callAddCoupon(p0, "cart", widget.backgroundcolor);
                                                                            },
                                                                          ));
                                                                        },
                                                                        child:
                                                                            AppText(
                                                                          text: controller.cartDetails["discount"] != null
