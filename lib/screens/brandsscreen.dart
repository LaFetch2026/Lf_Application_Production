...
Padding(
  ...
  child: GetBuilder<BrandController>(
    builder: (val) {
      ...
      // Sort alphabets
      List<String> sortedAlphabets = groupedBrands.keys.toList()..sort();
      ...
      return ListView.builder(
        ...
        itemBuilder: (ctx, a) {
          String alphabet = sortedAlphabets[a];
          List brandsForAlphabet = groupedBrands[alphabet] ?? [];
            ...
            children: [
              ...
              Padding(
                ...
                child: ListView.builder(
                  ...
                  shrinkWrap: true,
                  physics: const ScrollPhysics(),
                  itemCount: brandsForAlphabet.length,
                  padding: EdgeInsets.zero,
                  itemBuilder: (ctx, index) {
                    final brand = brandsForAlphabet[index];
                    final isExpanded = val.selectIndex.value == brand["id"];
                      ...
                      children: [
                        GestureDetector(
                          onTap: () async {
                            ...
                            await analytics.logEvent(
                              name: 'brand_details',
                              parameters: {'page_name': 'brand_details'},
                            );
                          },
                          child: Container(
                            ...
                            child: Row(
                              children: [
                                ...
                                InkWell(
                                  onTap: () {
                                    val.selectIndex.value = isExpanded ? 0 : brand["id"];
                                    val.update();
                                  },
                                  child: Padding(
                                    padding: EdgeInsets.symmetric(horizontal: 12.sp),
                                    child: SvgPicture.asset(
                                      isExpanded ? upDropDownSvgImage : dropdownSvgImage,
                                      color: colorPrimary,
                                      height: 7.sp,
                                      width: 11.sp,
                                    ),
