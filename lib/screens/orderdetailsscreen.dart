...
import '../common/widget/lists/dummy_order_address.dart';
import '../common/widget/lists/dummy_order_list.dart';
import '../common/widget/lists/dummy_orderpayment.dart';
              ...
              child: Column(
                ...
                children: [
                        ...
                        orderController.isDetails.value
                          ...
                          child: Container(
                            ...
                            child: Padding(
                              ...
                              child: Row(
                                children: [
                                  if (orderController.trackList[orderController
                                      .trackList.length - 1]
                                  ["status"] ==
                                      4) ...[
                                    Expanded(
                                    ...
                                    ["status"] ==
                                      ...
                                      if (orderController
                                          .trackList[orderController.trackList
                                          .length - 1]
                                      ["status"] ==
                                          2) ...[
                                        Expanded(
                  ...
                  orderController.isDetails.value
                    ...
                    child: AppText(
                      text:
                      "Refund amount: \u{20B9}${orderController
                          .orderDetails["refund_amount"].toString()}",
                      fontFamily: "Franklin Gothic",
                      fontWeight: FontWeight.w500,
                      color: deepRed,
                      maxLines: 4,
                                ...
                                child: Column(
                                  ...
                                  children: [
                                                    ...
                                                    [index]["status"] ==
                                                      ...
                                                      [index]["status"] ==
                                                        ...
                                                        [index]["status"] ==
                                                          ...
                                                          if (orderController
                                                              .orderDetails["orders"][index]["status"] ==
                                                              11) ...[
                                                            AnimatedContainer(
                                                              duration:
                                                              const Duration(
                                    ...
                                    Padding(
                                      ...
                                      child: AppText(
                                        text:
                                        "Order ID ${orderController
                                            .orderDetails["orders"][index]["reference"] ??
                                            ""} ",
                                        fontFamily:
                                        "Franklin Gothic Regular",
                                        fontWeight: FontWeight.w400,
                                                          ...
                                                          Row(
                                                            children: [
                                                              Expanded(
                                                                ...
                                                                1,
                                                                child: orderController
                                                                    .orderDetails["orders"][index]["order_lines"][i]["product"] !=
                                                                    null
                                                                    ? SizedBox(
                                                                  height: 85.sp,
                                                                  width: 70.sp,
                                                                  child: CachedNetworkImage(
                                                                    ...
                                                                    imageUrl: isImage(
                                                                        orderController
                                                                            .orderDetails["orders"][index]["order_lines"][i]["product"]["images"][0]["name"])
                                                                        ? orderController
                                                                        .orderDetails["orders"][index]["order_lines"][i]["product"]["images"][0]["name"]
                                                                        : orderController
                                                                        .orderDetails["orders"][index]["order_lines"][i]["product"]["images"][1]["name"],
                                                                    errorWidget: (
                                                                        context,
                                                                        url,
                                                                        error) =>
                                                                  ...
                                                                  children: [
                                                                    Padding(
                                                                      ...
                                                                      child: AppText(
                                                                        text: orderController
                                                                            ...
                                                                            null
                                                                            ? orderController
                                                                            .orderDetails["orders"][index]["order_lines"][i]["product"]["brand_name"] ??
                                                                            ""
                                                                            : "",
                                                                        maxLines: 1,
                                                                        fontFamily: "Franklin Gothic Regular",
                                                                    ...
                                                                    Padding(
                                                                      ...
                                                                      child: AppText(
                                                                        text: orderController
                                                                            ...
                                                                            null
                                                                            ? orderController
                                                                            .orderDetails["orders"][index]["order_lines"][i]["product"]["name"]
                                                                            : "",
                                                                        color: greyTextColor,
                                                                        maxLines: 2,
                                                                        fontSize: 12,
                                                                    ...
                                                                    Padding(
                                                                      ...
                                                                      child: Row(
                                                                        children: [
                                                                          orderController
                                                                              .orderDetails["orders"][index]["order_lines"][i]["inventory"] !=
                                                                              null
                                                                              ? Padding(
                                                                            padding: EdgeInsets
                                                                                .only(
                                                                            ...
                                                                            child: AppText(
                                                                              ...
                                                                              text: "Size : ${orderController
                                                                                  .orderDetails["orders"][index]["order_lines"][i]["inventory"]["product_matrix_name_size"] ??
                                                                                  ""}",
                                                                              color: greyTextColor,
                                                                              maxLines: 2,
                                                                              fontSize: 12,
                                                                          ...
                                                                          Padding(
                                                                            padding: EdgeInsets
                                                                                ...
                                                                                right: 10
                                                                                    .sp),
                                                                            child: AppText(
                                                                              text: "Qty :${orderController
                                                                                  .orderDetails["orders"][index]["order_lines"][i]["quantity"]
                                                                                  .toString()}",
                                                                              color: greyTextColor,
                                                                              maxLines: 2,
                                                                              fontSize: 12,
                                                                          ...
                                                                          AppText(
                                                                            text: "\u{20B9} ${orderController
                                                                                .orderDetails["orders"][index]["order_lines"][i]["unit_amount"] ??
                                                                                "0"}",
                                                                            color: greyTextColor,
                                                                            fontSize: 12,
                                                                            textAlign: TextAlign
                                                                    ...
                                                                    orderController
                                                                        .orderDetails["orders"][index]["status_details"] ==
                                                                        "DELIVERED" ||
                                                                        orderController
                                                                            .orderDetails["orders"][index]["status_details"] ==
                                                                            "COMPLETED" ||
                                                                      ...
                                                                      children: [
                                                                        orderController
                                                                            .orderDetails["order_lines"][index]["review"]
                                                                            ? GestureDetector(
                                                                          onTap: () async {
                                                                            Get
                                                                                .to(
                                                                                ReviewProductScreen(
                                                                                  orderId: orderController
                                                                                      .orderDetails["orders"][index]["id"],
                                                                                  productId: orderController
                                                                                      .orderDetails["orders"][index]["order_lines"][i]["product"] !=
                                                                                      null
                                                                                      ? orderController
                                                                                      .orderDetails["orders"][index]["order_lines"][i]["product"]["id"]
                                                                                      : 0,
                                                                        ...
                                                                        orderController
                                                                            .orderDetails["orders"][index]["order_lines"][i]["exchange"]
                                                                          ...
                                                                          onTap: () async {
                                                                            Get
                                                                                ...
                                                                                ExchangeProductScreen(
                                                                                    ...
                                                                                    orderId: orderController
                                                                                        .orderDetails["orders"][index]["id"],
                                                                                    sizeId: orderController
                                                                                        .orderDetails["orders"][index]["order_lines"][i]["inventory"]["id"] ??
                                                                                        0,
                                                                                    productDescription: orderController
                                                                                        .orderDetails["orders"][index]["order_lines"][i]["product"] !=
                                                                                        null
                                                                                        ? orderController
                                                                                        .orderDetails["orders"][index]["order_lines"][i]["product"]["brand_name"] ??
                                                                        ...
                                                                        ,
                                                                        orderController
                                                                            .orderDetails["orders"][index]["order_lines"][i]["reorder"]
                                                                            ? GestureDetector(
                                                                          onTap: () {
                                                                            productController
                                                                                .reorderSelected[index] =
                                                                            !productController
                                                                                .reorderSelected[index];
                                                                            productController
                                                                                .update();
                                                ...
                                                children: [
                                                  Padding(
                                                    padding: EdgeInsets
                                                        ...
                                                        2.sp),
                                                    child: orderController
                                                        .orderDetails["orders"][index]["deliveries"]
                                                        .any((map) =>
                                                    map['status_details'] ==
                                                        orderItem[
                                                        i])
                                      ...
                                      child: Container(
                                        ...
                                        child: Padding(
                                          ...
                                          child: Row(
                                            children: [
                                              if (orderController
                                                  .orderDetails["orders"][index]["deliveries"][orderController
                                                  .orderDetails["orders"][index]["deliveries"]
                                                  .length - 1]["status"] ==
                                                  4) ...[
                                                Expanded(
                                                ...
                                                "status"] ==
                                                  ...
                                                  if (orderController
                                                      .orderDetails["orders"]
                                                  [index]["deliveries"][orderController
                                                      .orderDetails["orders"][index]["deliveries"]
                                                      .length - 1][
                                                  "status"] ==
                                                      2) ...[
                                    ...
                                    ["status"] ==
                                      ...
                                      child: AppText(
                                        text:
                                        "Refund id: ${orderController
                                            .orderDetails["orders"][index]["refund_id"] ??
                                            ""}",
                                        fontFamily:
                                        "Franklin Gothic",
                                        fontWeight:
                                    ...
                                    ["status"] ==
                                      ...
                                      child: AppText(
                                        text:
                                        "Refund amount: \u{20B9}${orderController
                                            .orderDetails["orders"][index]["refund_amount"]
                                            .toString()}",
                                        fontFamily:
                                        "Franklin Gothic",
                                        fontWeight:
                                                            ...
                                                            Row(
                                                              children: [
                                                                Expanded(
                                                                  flex: 1,
                                                                  child: orderController
                                                                      .orderDetails["order_lines"][index]["product"] !=
                                                                      null
                                                                      ? SizedBox(
                                                                    height: 85
                                                                        .sp,
                                                                    ...
                                                                    child: CachedNetworkImage(
                                                                      ...
                                                                      imageUrl: isImage(
                                                                          orderController
                                                                              .orderDetails["order_lines"][index]["product"]["images"][0]["name"])
                                                                          ? orderController
                                                                          .orderDetails["order_lines"][index]["product"]["images"][0]["name"]
                                                                          : orderController
                                                                          .orderDetails["order_lines"][index]["product"]["images"][1]["name"],
                                                                      errorWidget: (
                                                                          context,
                                                                          url,
                                                                          error) =>
                                                                    ...
                                                                    children: [
                                                                      Padding(
                                                                        ...
                                                                        child: AppText(
                                                                          text: orderController
                                                                              ...
                                                                              null
                                                                              ? orderController
                                                                              .orderDetails["order_lines"][index]["product"]["brand_name"] ??
                                                                              ""
                                                                              : "",
                                                                          maxLines: 1,
                                                                          fontFamily: "Franklin Gothic Regular",
                                                                      ...
                                                                      Padding(
                                                                        ...
                                                                        child: AppText(
                                                                          text: orderController
                                                                              ...
                                                                              null
                                                                              ? orderController
                                                                              .orderDetails["order_lines"][index]["product"]["name"]
                                                                              : "",
                                                                          color: greyTextColor,
                                                                          maxLines: 2,
                                                                          fontSize: 12,
                                                                      ...
                                                                      Padding(
                                                                        ...
                                                                        child: Row(
                                                                          children: [
                                                                            orderController
                                                                                .orderDetails["order_lines"][index]["inventory"] !=
                                                                                null
                                                                                ? Padding(
                                                                              padding: EdgeInsets
                                                                                  .only(
                                                                              ...
                                                                              child: AppText(
                                                                                // text: "Size :${orderController.orderDetails["order_lines"][0]["product"]["inventories"][orderController.orderDetails["order_lines"][0]["product"]["inventories"].indexWhere((f) => f['product_matrix']['product_matrix_group']["name"] == "Size")]['product_matrix']["name"]}",
                                                                                text: "Size : ${orderController
                                                                                    .orderDetails["order_lines"][index]["inventory"]["product_matrix_name_size"] ??
                                                                                    ""}",
                                                                                color: greyTextColor,
                                                                                maxLines: 2,
                                                                                fontSize: 12,
                                                                            ...
                                                                            Padding(
                                                                              ...
                                                                              child: AppText(
                                                                                text: "Qty :${orderController
                                                                                    .orderDetails["order_lines"][index]["quantity"]
                                                                                    .toString()}",
                                                                                color: greyTextColor,
                                                                                maxLines: 2,
                                                                                fontSize: 12,
                                                                            ...
                                                                            AppText(
                                                                              text: "\u{20B9} ${orderController
                                                                                  .orderDetails["order_lines"][index]["unit_amount"] ??
                                                                                  "0"}",
                                                                              color: greyTextColor,
                                                                              fontSize: 12,
                                                                              textAlign: TextAlign
                                                                      ...
                                                                      orderController
                                                                        ...
                                                                        children: [
                                                                              ...
                                                                              Get
                                                                                  ...
                                                                                  ReviewProductScreen(
                                                                                    ...
                                                                                    productId: orderController
                                                                                        ...
                                                                                        null
                                                                                        ? orderController
                                                                                        .orderDetails["order_lines"][index]["product"]["id"]
                                                                                        : 0,
                                                                                    productName: orderController
                                                                                        .orderDetails["order_lines"][index]["product"] !=
                                                                                        null
                                                                          ...
                                                                          orderController
                                                                              .orderDetails["order_lines"][index]["exchange"]
                                                                              ...
                                                                              Get
                                                                                  ...
                                                                                  ExchangeProductScreen(
                                                                                      ...
                                                                                      orderId: orderController
                                                                                          .orderDetails["id"],
                                                                                      sizeId: orderController
                                                                                          .orderDetails["order_lines"][index]["inventory"]["id"] ??
                                                                                          0,
                                                                                      productDescription: orderController
                                                                                          .orderDetails["order_lines"][index]["product"] !=
                                                                                          null
                                                                          ...
                                                                          ,
                                                                          orderController
                                                                              .orderDetails["order_lines"][index]["reorder"]
                                                                              ? GestureDetector(
                                                                            onTap: () {
                                                                              productController
                                                                                  .reorderSelected[index] =
                              ...
                              child: Row(
                                ...
                                children: [
                                  ...
                                  AppText(
                                    text:
                                    "\u{20B9} ${orderController
                                        .orderDetails["express_delivery_charges"] ??
                                        "0"}",
                                    fontFamily:
                                    "Franklin Gothic Regular",
                                    fontWeight: FontWeight.w400,
                              ...
                              child: Row(
                                ...
                                children: [
                                  ...
                                  AppText(
                                    text:
                                    "\u{20B9} ${orderController
                                        .orderDetails["total_tax"].toString()}",
                                    fontFamily: "Franklin Gothic Regular",
                                    fontWeight: FontWeight.w400,
                                    color: textColor,
                                    fontSize: 12,
