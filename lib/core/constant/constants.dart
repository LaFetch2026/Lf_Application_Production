...
const Color deepLavender = Color(0xFF6B5B95);
const Color underlineColor = Color(0xFF786E85);
const Color lavenderText = Color(0xFFB57EDC);
const Color greyBorder = Color(0xFFAFB1B6);
const Color color5StartReview = Color(0xFF9575CD);
const Color color4StartReview = Color(0xFFB57EDC);
const Color color3StartReview = Color(0xFFB57EDC);
...
const Color homeAppBarGradientStart = Color(0xFFFFFFFF);
const Color homeAppBarGradientMiddle = Color(0xFFBB08FF);
const Color homeAppBarGradientEnd = Color(0xFF9989FF);
const Color homeAppBarSearchBackground = Color(0xFFFFFFFF);
const Color homeAppBarSearchBorder = Color(0xFFEDE8FF);
const Color homeAppBarHintColor = Color(0xFF9CA3AF);
const Color homeAppBarIconColor = Color(0xFF1F1C21);
const Color homeAppBarShadowColor = Color(0x1A1F1C21);
...
const Color snackBarBrandColor = Color(0xFF988AFF);
...
const newWishlistIcon = 'assets/images/new_wishlist_icon.svg';
...
const newCartSvgImage = 'assets/images/new_cart_icon.svg';
const applogSvgImage = 'assets/images/logo.png';
const applogoCondensed = 'assets/images/lafetch_logo.png';
...
const newProfileImage = 'assets/images/profile_icon.svg';
