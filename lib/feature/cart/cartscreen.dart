...
import '../board/newboardscreen.dart';
import '../checkout/change_address.dart';
import '../misc/mapscreen.dart';
import '../payament/paymentcheckscreen.dart';
import '../payament/paymentsuccessscreen.dart';
                                                          ...
                                                          children: [
                                                                ...
                                                                children: [
                                                                  GestureDetector(
                                                                    ...
                                                                    child: Container(
                                                                      ...
                                                                      child: AppText(
                                                                        text: value.orderList[index]["product"]["brand_name"] != null ? value.orderList[index]["product"]["brand_name"].toUpperCase() : "",
                                                                        maxLines: 1,
                                                            ...
                                                            GestureDetector(
                                                              ...
                                                              Container(
                                                                ...
                                                                Colors.transparent,
                                                                child:
                                                                Padding(padding: EdgeInsets.symmetric(horizontal: 6.sp, vertical: 6.sp), child: SvgPicture.asset(crossSearchImage, color: widget.backgroundcolor == whiteColor ? homeAppBarColor : whiteColor, height: 9.sp, width: 9.sp, fit: BoxFit.cover)),
                                                              ),
                                                            ),
                                                          ],
                                                        ),
